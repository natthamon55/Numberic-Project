...
class Ui_GUI(object):
    def setupUi(self, GUI):
        ...
        self.label.setGeometry(QtCore.QRect(190, 20, 231, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.equation.setGeometry(QtCore.QRect(440, 10, 241, 31))
        self.equation.setObjectName("equation")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(245, 120, 131, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.t1.setGeometry(QtCore.QRect(435, 110, 51, 31))
        self.t1.setObjectName("t1")
        self.t2 = QtWidgets.QTextEdit(self.centralwidget)
        self.t2.setGeometry(QtCore.QRect(540, 110, 51, 31))
        self.t2.setObjectName("t2")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(500, 120, 16, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.g1.setGeometry(QtCore.QRect(40, 170, 461, 311))
        ...
        self.g2.setGeometry(QtCore.QRect(540, 170, 461, 311))
        ...
        self.label_4.setGeometry(QtCore.QRect(225, 150, 55, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_5.setGeometry(QtCore.QRect(735, 150, 101, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_6.setGeometry(QtCore.QRect(330, 550, 55, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_7.setGeometry(QtCore.QRect(520, 550, 61, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_9.setGeometry(QtCore.QRect(480, 510, 101, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_11.setGeometry(QtCore.QRect(490, 550, 16, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_12.setGeometry(QtCore.QRect(700, 550, 31, 16))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.b1.setGeometry(QtCore.QRect(720, 60, 121, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_8.setGeometry(QtCore.QRect(305, 70, 111, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.equation_2.setGeometry(QtCore.QRect(440, 60, 71, 31))
        self.equation_2.setObjectName("equation_2")
        self.t_ode = QtWidgets.QLineEdit(self.centralwidget)
        self.t_ode.setGeometry(QtCore.QRect(390, 540, 91, 31))
        self.t_ode.setObjectName("t_ode")
        self.t_sol = QtWidgets.QLineEdit(self.centralwidget)
        self.t_sol.setGeometry(QtCore.QRect(590, 540, 101, 31))
    ...
    def translate2graph(self):
        ...
        self.t_ode.setText(ode_time[0:12])
        self.t_sol.setText(ivp_time[0:12])
